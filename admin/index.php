            ...
            <div class="list-group">
              <a href="index.php?page=dashboard" class="list-group-item list-group-item-action active">
               <i class="fas fa-tachometer-alt"></i> Dashboard
                  ...
                  <?php } ?>
                  <?php if ($showrow['userRole'] === 'student') { ?>
                      <a href="index.php?page=course-registration" class="list-group-item list-group-item-action"><i class="fa fa-user-plus"></i> Course Registration</a>
                  <?php } ?>
